...
配点の重みは、必ず以下の順で高く設定せよ。
 1. 内容一致問題 (目安: 最大でも1問7〜8点程度)
 2. 説明問題 (目安: 1問4〜6点程度)
 3. 非完全英文選択肢問題・長文外大問 (目安: 1問2〜3点程度)
この優先順位を逆転させる配点設計は禁止とする。

【2. 配点の極端な偏りの禁止】
特定の一問に対してのみ10点や12点といった異常に高い配点を割り振ることは絶対に禁止する。
全体で自然に点数が分散されるように設定すること。
...
・2-3配点上限: どんなに配点の高い論述問題であっても、1問につき10点を超えないように調整し、極端な偏り（特定の問題だけ12点など）を発生させないこと。
